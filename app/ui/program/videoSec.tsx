...
export default function VideoSec() {
    return(<div className="my-6 bg-black py-6 px-2">
        <div className="max-w-6xl mx-auto">
            <div className="text-white px-2 pt-11 pb-4">
                <h3 className="text-4xl font-bold text-center md:text-left">Check out the Sample Video</h3>
                <p className="my-2 text-lg font-bold">This Video will give you a very brief insight into the dynamics of Power BI Assured with Skill Craft</p>
            </div>
