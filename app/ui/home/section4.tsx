...
export default function Section4() {
    return(<div className="my-14 bg-sec4-bg bg-no-repeat bg-center md:bg-fixed w-full">
        <div className="bg-[#007991] bg-opacity-80 full pt-24 px-11 lg:flex justify-evenly">
            ...
            <div className="bg-white p-8 w-full sm:w-1/2 lg:w-2/6 my-11 lg:my-0">
                <div className="text-3xl my-6 font-bold leading-8">Do you have The Potential But Don't have the opportunity?</div>
                <div className=""><Link href="/program" className="">&#x27A4;  Explore Placed</Link></div>
            </div>
        </div>
    </div>)
}
