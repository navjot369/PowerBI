export default function VideoSec() {
    return(<div className="my-11 mx-auto w-full max-w-6xl flex flex-col items-center px-11">
        <div className="text-3xl sm:text-6xl font-bold text-center my-4">What is Placed?</div>
