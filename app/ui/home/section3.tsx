...
export default function Section3() {
    return (<div className="grid grid-cols-[1fr] md:grid-cols-[2fr_1px_3fr] px-4 mx-auto max-w-6xl my-20">
        <div className="text-3xl sm:text-5xl font-bold px-2 text-center md:text-left">Tech Stack you will Build</div>
        <div className="bg-[#ff9635] shrink-0 w-1 hidden md:block"></div>
        <div className="flex flex-nowrap justify-evenly items-stretc py-4 h-auto lg:h-24 w-full">
