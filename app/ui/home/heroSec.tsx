        ...
        <div className="w-full min-h-[700px] bg-[#007991] bg-opacity-80">
          <div className="max-w-[1200px] h-[700px] flex items-center p-2 min-[820px]:p-11 min-[936px]:p-28">
            <div className="flex flex-col text-white">
              <div className="text-5xl min-[630px]:text-8xl font-bold my-2">From Projects</div>
              <div className="text-5xl min-[630px]:text-8xl font-bold my-2">to Placement</div>
              <div className="text-xl min-[630px]:text-3xl mb-11">100% Assured Placement</div>
