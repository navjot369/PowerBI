...
export default function HeroSection() {
  return (
    <div className="w-full rounded-br-[140px] bg-hero-bg-image bg-fixed bg-[center_right] overflow-hidden bg-no-repeat bg-cover">
      <div className="w-full pt-24 pb-11 sm:min-h-[700px] sm:h-[700px] bg-[#007991] bg-opacity-80">
        <div className="max-w-[1200px] sm:min-h-[700px] flex items-center p-2 min-[820px]:p-11 min-[936px]:p-28">
