...
function Box({
  ...
  return (
    <div className="bg-[white] w-full m-2 flex flex-col md:flex-row justify-evenly items-center shadow-[4px_4px_10px_0_#088] hover:shadow-[4px_4px_10px_4px_#ccc] hover:scale-[1.01] transition-all duration-500 px-4 rounded-lg">
      <div className="w-1/2">
        <Image
          src={banner}
          alt="Banner"
      ...
      <div className="px-4 py-8  flex flex-col items-start">
        ...
        <div className="w-full my-11 flex items-center justify-center">
          <Link
            href={linkSrc}
            className="w-[80%] block bg-[#008182] px-1 py-2 my-2 ml-auto mr-10 text-center text-[white] hover:bg-[#088] rounded-full"
          >
            View Course
          </Link>
        </div>
