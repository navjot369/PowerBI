...
export default function Layout({children} : {
    ...
    return(<div className="w-screen h-screen bg-cover bg-login-wall bg-no-repeat flex justify-center items-center">
        <div className="grid w-full mx-8 lg:w-[1000px] h-[80vh] grid-cols-1 grid-rows-1 md:grid-cols-2 md:grid-rows-1 bg-slate-500 bg-opacity-80 shadow-[0_0_20px_#666] rounded-xl overflow-hidden">
